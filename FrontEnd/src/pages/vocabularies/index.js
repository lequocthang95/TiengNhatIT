...
const columns = [
  ...
  function createData(name, furigana, meaning) {
    
    return { name, furigana, meaning };
  }
            ...
            <TableHead>
                <TableRow>
                    ...
                    <TableCell
                        key={column.id}
                        align='center'
                        style={{ minWidth: column.minWidth, maxWidth: column.maxWidth, backgroundColor: column.backgroundColor}}
                    >
                        {column.label}
                    </TableCell>
                    ))}
